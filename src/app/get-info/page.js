      ...
      <div className="wrapper">
        <article>
          ...
          <p className="introduction">
            Join us for the ultimate skiing &amp; snowboarding event and 4 days
            of skiing, partying, and having real fun!
          </p>
          <p>
            Every year Mirabeau organises a ski event for all employees and this
            year the event takes place in the ski resort{' '}
            <a href="/get-info/location">Sankt Anton</a>, in the west of
          ...
          <div className="extra-info">
            ...
            <section className="extra-info__item">
              <h2>Optional:</h2>
              <p>
                We can provide you with a skipass that will give you access to
                over 340 km of ski runs.
              </p>
              <p>
                Skiing and boarding equipment can be rented at destination,
                prices starting at €69 for a 3 days depending on quality of the
                gear. You can also take ski or snowboard lessons together with
                some colleagues in case your skills are a little rusty.
              </p>
            </section>
            ...
            <section className="extra-info__item">
              <h2>Price</h2>
              <p>
                Based on previous editions, the price will be around €250,- The
                rest of your trip is sponsored by Mirabeau. As soon as the exact
                price is available you’ll be informed.
              </p>
            </section>
            ...
            <section className="extra-info__item">
              <h2>When</h2>
              <p>
                We’ll leave on Friday afternoon, the 26th of January and we’ll
                be back in the Netherlands on the early morning of Wednesday the
                31th of January.
              </p>
            </section>
          </div>
