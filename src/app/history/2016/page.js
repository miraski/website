  ...
  return (
    <body>
      ...
      <div className="wrapper">
        <History year={2016} HistoryText={HistoryText} attendees={attendees} />
      </div>
    </body>
  )
}
  ...
  return (
    <>
      ...
      <p>
        ...
        Enzianhütte, our favourite meet-up place, was pretty crowded early in
        the afternoon with digital natives. Next to the Après-ski classics we
