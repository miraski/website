...
class Ui {
  ...
  _cacheSelectors() {
    ...
    this._finalScore = this._element.querySelector('[data-final-score]')
  ...
  _addEventListeners() {
    ...
    this._sound.addEventListener('change', (evt) =>
      this._toggleSound(evt.target.checked),
    )
  }
