  ...
  return (
    <article>
      ...
      <p className="introduction">
        More than 340 kilometres of virgin powder is available at the superbly
        prepared slopes at Sankt Anton ski area.
      </p>
      <p>
        Nasserein ski lift, next to chalet Alber, puts you in the middle of the
      ...
      <p>
        ...
        additionally approximately 180 kilometres of off-piste opportunities and
        is varied and challenging for advanced skiers but also very suitable for
        beginners. The likelihood of snow is very high in this area, so valley
        runs are possible until late in the season.
      </p>
      <ul>
      ...
      <section>
        ...
        <p>
          ...
          24) leading to the Nasserein skilift. You can ski back to the chalet,
      ...
      <section>
        ...
        <p>
          St Anton is widely recognised as the après-ski capital of the Alps and
          attracts flocks of young skiers who embrace the nightlife
          wholeheartedly.
        </p>
        <p>
          St Anton is almost as famous for its après as it is for its skiing, so
          be prepared to party when you come here. The nightlife start from
          23.00.
        </p>
        <p>
